...
export declare class Dialogs extends IonicNativePlugin {
     ...
     */
    confirm(message: string, title?: string, buttonLabels?: string[], cancelable?: boolean): Promise<number>;
    /**
     ...
     */
    prompt(message?: string, title?: string, buttonLabels?: string[], defaultText?: string, cancelable?: boolean): Promise<DialogsPromptCallback>;
    /**
